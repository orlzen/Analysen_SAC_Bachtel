...
```{r Einlesen Daten Anmeldung & Ausschreibungen, include = FALSE}
...
```{r Anmeldungen bearbeiten, include = FALSE}
temp2016 <- c(
...
anm_2021_klein <- anm_2021[temp2020]
...
```{r Ausschreibungen bearbeiten, include = FALSE}
...
auss_total <- rbind(
  ...
  auss_2020_klein, auss_2021_klein, auss_2022_klein
)
